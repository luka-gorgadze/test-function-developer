namespace parallel {
	...
	{
		g[n - 1] = 0;
		double fx = valgradParallelOneCongestion(ARWHEADRanged, x, g, n, n - 1);
		double group1(0.0);
	...
	double BDQRTIC(double *x, double *g, const int n) {
		double fx = valgradParallelOneCongestion(BDQRTICRanged, x, g, n, n - 1);
	...
	double CHAINWOO(double *x, double *g, const int n) {
		double fx = 1.0 + valgradParallel(CHAINWOORanged, x, g, n);
	...
	{
		double item;
		double fx = valgradParallel(COSINERanged, x, g, n);
	...
	double CRAGGLVY(double *x, double *g, const int n) {
		double fx = 1.0 + valgradParallel(CRAGGLVYRanged, x, g, n);
		for (int i = block_size - 3; i < n - 3; i = i + block_size) {
	...
	)
	{
		...
		int m(n / 3);
		initializer(n, 100);
		valgradParallel(DIXMAANARanged1, x, g, n);
		initializer(m, 100);
		fx += valgradParallelRangedWithM(DIXMAANARanged2, x, g, 0, m, m);
		initializer(m, 100);
		fx += valgradParallelRangedWithM(DIXMAANARanged3, x, g, m, 2 * m, m);
		initializer(n - (2 * m), 100);
		fx += valgradParallelRangedWithM(DIXMAANARanged4, x, g, 2 * m, n, m);
		return fx;
	}
	...
	)
	{
		...
		initializer(n, 100);
		valgradParallel(DIXMAANBRanged1, x, g, n);
		initializer(m, 100);
		fx += valgradParallelRangedWithM(DIXMAANBRanged2, x, g, 0, m, m);
		initializer(m, 100);
		fx += valgradParallelRangedWithM(DIXMAANBRanged3, x, g, m, 2 * m, m);
		initializer(n - (2 * m), 100);
		fx += valgradParallelRangedWithM(DIXMAANBRanged4, x, g, 2 * m, n, m);
	...
	)
	{
		...
		initializer(n, 100);
		valgradParallel(DIXMAANIRanged1, x, g, n);
		initializer(m, 100);
		fx += valgradParallelRangedWithMWithN(DIXMAANIRanged2, x, g, 0, m, m, n);
		initializer(m, 100);
		fx += valgradParallelRangedWithMWithN(DIXMAANIRanged3, x, g, m, 2 * m, m, n);
		initializer(n - (2 * m), 100);
		fx += valgradParallelRangedWithMWithN(DIXMAANIRanged4, x, g, 2 * m, n, m, n);
		return fx;
	}
	...
	)
	{
		...
		initializer(n, 100);
		valgradParallel(DIXMAANJRanged1, x, g, n);
		initializer(m, 100);
		fx += valgradParallelRangedWithMWithN(DIXMAANJRanged2, x, g, 0, m, m, n);
		initializer(m, 100);
		fx += valgradParallelRangedWithMWithN(DIXMAANJRanged3, x, g, m, 2 * m, m, n);
		initializer(n - (2 * m), 100);
		fx += valgradParallelRangedWithMWithN(DIXMAANJRanged4, x, g, 2 * m, n, m, n);
	...
	{
		double item;
		double fx = valgradParallel(DIXON3DQRanged, x, g, n);
	...
	{
		double fx = valgradParallel(DQDRTICRanged, x, g, n);
		double t0, t1, t2;
	...
	double DQRTIC(double *x, double *g, const int n) {
		return valgradParallel(DQRTICRanged, x, g, n);
	}
	void InitialDQRTIC
	(
		double *x,
	...
	{
		double fx = valgradParallel(EDENSCHRanged, x, g, n);
		double item1, item2, item3;
		double squaredItem1;
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
	...
	{
		double fx = 0.5*sin(pow(x[n - 1], 2)) + valgradParallelOneCongestion(EG2Ranged, x, g, n, 0);
	...
	{
		double item;
		double fx = valgradParallel(ENGVAL1Ranged, x, g, n);
	...
	{
		double item(x[0] - 1);
		double fx = (pow(item, 2)) + valgradParallel(EXTROSNBRanged, x, g, n);
		g[0] += 2 * item;
	...
	{
		double item;
		double fx = valgradParallel(FLETCHRRanged, x, g, n);
	...
	{
		double fx = valgradParallel(FREUROTHRanged, x, g, n);
		double item1, item2;
	...
	)
	{
		...
		double item22;
		double t0, t1;
		double fx = valgradParallel(GENHUMPSRanged, x, g, n);
		for (int i = block_size - 1; i < n - 1; i += block_size)
		{
			item1 = sin(2.0*x[i]);
			item2 = sin(2.0*x[i + 1]);
	...
	{
		double fx = 1.0 + valgradParallel(GENROSERanged, x, g, n);
		double item1, item2;
	...
	{
		return valgradParallelOneCongestion(LIARWDHRanged, x, g, n, 0);
	}
	void InitialLIARWDH
	(
		double *x,
	...
	{
		double item, tmp;
		double fx = valgradParallelOneCongestion(NONDQUARRanged, x, g, n, n - 1);
	...
	double POWER(double *x, double *g, const int n) {
		return valgradParallel(POWERRanged, x, g, n);
	}
	void InitialPOWER
	(
		double *x,
	...
	{
		return valgradParallel(SROSENBRRanged, x, g, n);
	}
	...
	{
		double item(x[0] - 1.0);
		double fx = (item*item) + valgradParallel(TRIDIARanged, x, g, n);
		g[0] += 2.0*item;
	...
	double WOODS(double *x, double *g, const int n) {
		double fx = valgradParallel(WOODSRanged, x, g, n);
		for (int i = block_size - 3; i < n - 3; i = i + block_size) {
